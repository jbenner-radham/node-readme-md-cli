...
------------
### Added
- Added a `readme-md init` command to initialize a project with a default config.
...
[Unreleased]: https://github.com/jbenner-radham/node-readme-md-cli/compare/v0.8.1...HEAD
